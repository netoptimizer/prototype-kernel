...
#
# NOTICE
#	This script is copied from the Linux kernel
#
#	Original path in kernel tree:
#	  kernel/tools/testing/fault-injection/failcmd.sh
#
#	also avail via this git link:
#	  https://git.kernel.org/cgit/linux/kernel/git/torvalds/linux.git/tree/tools/testing/fault-injection/failcmd.sh
#
